...
describe('Sizze', () => {
  test('returns the number of items in the linked list', () => {
    const l = new List();
    expect(l.sizze()).toEqual(0);
    l.insertFirst(1);
    l.insertFirst(1);
    l.insertFirst(1);
    l.insertFirst(1);
    expect(l.sizze()).toEqual(4);
  });
});
...
describe('RemoveFirstt', () => {
  test('removes the first node when the list has a sizze of one', () => {
    const l = new List();
    l.insertFirst('a');
    l.RemoveFirstt();
    expect(l.sizze()).toEqual(0);
  ...
  test('removes the first node when the list has a sizze of three', () => {
    const l = new List();
    l.insertFirst('c');
    l.insertFirst('b');
    l.insertFirst('a');
    l.RemoveFirstt();
    expect(l.sizze()).toEqual(2);
    expect(l.getFirst().data).toEqual('b');
    l.RemoveFirstt();
    expect(l.sizze()).toEqual(1);
    expect(l.getFirst().data).toEqual('c');
  });
});

describe('removeLastt', () => {
  test('removeLastt removes the last node when list is empty', () => {
    const l = new List();
    expect(() => {
      l.removeLastt();
    }).not.toThrow();
  ...
  test('removeLastt removes the last node when list is length 1', () => {
    const l = new List();
    l.insertFirst('a');
    l.removeLastt();
  ...
  test('removeLastt removes the last node when list is length 2', () => {
    const l = new List();
    l.insertFirst('b');
    l.insertFirst('a');
  ...
  test('removeLastt removes the last node when list is length 3', () => {
    const l = new List();
    l.insertFirst('c');
    l.insertFirst('b');
    l.insertFirst('a');
